...
@registry.register_task_model('prosit_fragmentation_vanilla_attention_cid', 'transformer')
@registry.register_task_model('prosit_fragmentation_vanilla_attention_hcd', 'transformer')
class ProteinBertForValuePredictionFragmentationProsit(ProteinBertAbstractModel):
...
class ProteinBertForValuePredictionFragmentationProsit(ProteinBertAbstractModel):
    ...
    def __init__(self, config):
        ...
        tmp_config = type('tmp_config', (object,), dict(vars(config), num_hidden_layers=9))
